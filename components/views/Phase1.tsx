...
function Timer(): ReactElement {
	...
	const time = useTimer({endTime: Number(whitelistEnd)});
...
function Phase1({variant}: {variant: string[]}): ReactElement {
	...
	return (
		<section className={'absolute inset-x-0'}>
			<div
				className={'scrollfix grid grid-cols-12 gap-0 px-4 pt-10 md:gap-20 md:pt-12'}>
				<div className={'col-span-12 h-full md:col-span-6 md:mb-0'}>
