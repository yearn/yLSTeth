...
import {VoteConfirmationModal} from 'app/components/bootstrapViews/Vote.ConfirmationModal';
...
import type {TTokenExtra} from 'app/hooks/useBootstrapWhitelistedLST';
...
type TVoteListItem = {
	...
	updateToMax: (item: TTokenExtra) => void;
};
