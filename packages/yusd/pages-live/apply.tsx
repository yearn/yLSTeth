...
import {apply} from '@yUSD/actions';
...
function Form(): ReactElement {
	...
	/**************************************************************************
	 * On submit, propose the LST address for inclusion in the yUSD basket.
	 *************************************************************************/
	...
	function renderActionButton(): ReactElement {
			...
			return (
				<Button
					...
					isDisabled={
						...
						// hasAlreadyApplied ||
						!feeForApplication ||
						(feeForApplication && yUSDBalance.raw < feeForApplication?.raw)
					}>
					{'Apply'}
				</Button>
			);
		...
		return (
			<Button
				...
				onClick={onApprove}
				suppressHydrationWarning>
				{`Approve ${feeForApplication?.raw ? formatAmount(feeForApplication?.normalized, 2, 6) : '0'} yUSD`}
			</Button>
		);
	}
			...
			<div className={'pt-8'}>
				...
				<small className={'text-red-900'}>
					{hasAlreadyApplied || isAlreadyInBasket
						? 'This LST has already been proposed for inclusion in the yUSD basket.'
						: ''}
					&nbsp;
				</small>
			</div>
						...
						<div className={'mb-8 text-neutral-700'}>
							...
							<ul className={'list-outside list-disc pl-4'}>
								<li className={'font-bold'}>
									{'Pay a non refundable 0.1-1 yUSD fee (to prevent spam).'}
								</li>
