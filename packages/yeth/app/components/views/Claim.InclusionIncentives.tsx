...
import {claimManyInclusionIncentive} from '@yETH/actions';
import useInclusion from '@yETH/contexts/useInclusion';
import {usePrices} from '@yETH/contexts/usePrices';
					...
					<label
						...
						<div>
							<input
								...
								type={'checkbox'}
								className={
									'-mt-1 size-[14px] rounded-[4px] border-0 border-neutral-400 bg-neutral-200 text-purple-300 indeterminate:ring-2 focus:bg-neutral-200 focus:ring-2 focus:ring-purple-300 focus:ring-offset-neutral-100'
								}
							/>
						</div>
