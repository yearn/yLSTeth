...
import {formatDate} from '@yETH/utils';
			...
			<div className={'-mt-36'}>
				...
				<div className={'mt-10 grid grid-cols-2 flex-row gap-4 px-4 md:flex md:px-72'}>
					<Link
						...
						<div
							className={
								'border-neutral-0 text-neutral-0 hover:bg-neutral-0 flex cursor-pointer flex-row items-center justify-center rounded border px-3 py-2 text-center text-xs transition-colors hover:text-purple-300'
							}>
							{'Pool'}
					...
					<Link
						href={`https://etherscan.io/address/${process.env.YETH_ADDRESS}`}
						target={'_blank'}>
						<div
							className={
								'border-neutral-0 text-neutral-0 hover:bg-neutral-0 flex cursor-pointer flex-row items-center justify-center rounded border px-3 py-2 text-center text-xs transition-colors hover:text-purple-300'
					...
					<Link
						href={`https://etherscan.io/address/${process.env.STYETH_ADDRESS}`}
						target={'_blank'}>
						<div
							className={
								'border-neutral-0 text-neutral-0 hover:bg-neutral-0 flex cursor-pointer flex-row items-center justify-center rounded border px-3 py-2 text-center text-xs transition-colors hover:text-purple-300'
